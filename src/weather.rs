...
/// Provides API to retrieve the minimum temperature for a given postcode.
///
...
/// Calls an API from weatherapi.com and returns Future.
///
/// Function requires API key and postcode else a 401 unathorised error occurs.
///
/// ## Errors
///
/// - Returns [`Result<String, Box<dyn std::error::Error>>`](std::error::Error) - if the GET request is unsuccessful.
